...
&emsp;[Part 1:  Getting the workshop files and configuring GitHub for automated testing and results publishing](#TMP_6747)
 
&emsp;[Part 2:  Generating your first tests](#TMP_4c05)
 
&emsp;[Part 3:  Finding existing tests and measuring coverage](#TMP_9c36)
 
&emsp;[Part 4:  Updating badges, committing our changes, and pushing to GitHub](#TMP_8cb6)
 
&emsp;[Part 5:  Create a pull request, watch GitHub Actions automatically test your changes and publish results](#TMP_982a)
 
&emsp;[Workshop wrap\-up and additional information](#TMP_59ba)
...
The test done on line 29&30 in `testSimulateFunction` does not seem right. Let's delete those 2 lines and rerun the test.
...
It was great that we already had tests for [`generateSimFun`](./code/generateSimFun.m) , but how much of [`generateSimFun`](./code/generateSimFun.m)  being exercised by those tests?
...
![image_71.svg](./WorkshopGuide_media/image_71.svg)
...
![image_72.svg](./WorkshopGuide_media/image_72.svg)
...
![image_77.svg](./WorkshopGuide_media/image_77.svg)
...
![image_79.svg](./WorkshopGuide_media/image_79.svg)
...
If no conflict is detected, it should suggest to perform merging:
...
You can then safely delete the dev branch:
...
**Part 5.2:  Watch GitHub Actions automatically test your code and publish our results**


Once you confirm merging, GitHub Actions will automatically test your code and publish your test results.
